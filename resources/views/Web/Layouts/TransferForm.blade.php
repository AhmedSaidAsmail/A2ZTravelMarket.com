                ...
                <div class="transfer-form-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="arrival_date" type="text" class="form-control" id="arrival_date">
                                </div>
                                <!-- /.input group -->
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="transfer_type" class="form-control"  id="transfer-type" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="transfer_times" class="form-control" id="choose_times">
                    ...
                    <div class="row">
                        <div class="col-md-12 transfer-text-label">
                            ...
                            {{vars::getVar('Please_select_the_number_of_Pax_for_transfer')}}
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">

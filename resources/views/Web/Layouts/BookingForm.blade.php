    ...
    <form action="{{route('add.to.cart',['id'=>$item->id])}}" method="post">
        ...
        <div class="row booking-form">
            <div class="row booking-form-row">
                ...
                <div class="col-md-7 col-lg-5 text-right" id="first-price" >{{$item->price->st_price}}.00 <span>{{ Vars::getVar("$") }}</div>
            </div>
            <div class="row booking-form-row">
            ...
            <div class="row booking-form-row-inputs">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="daysoff" data="{{route('getDays',['id'=>$item->id])}}"></div>
                        <label>
                            <i class="fa fa-calendar"></i> {{Vars::getVar('Select_a_date')}}
                        </label>
                        <input name="date" type="text" class="form-control" id="booking_date" >
                    </div>
                </div>
            </div>

            <div class="row booking-form-row-select ">
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row text-center booking-form-row-normal">
                <button class="btn btn-info  btn-block booking-form-submit">
                ...
                <h3 class="text-center price-gurantee">
                    <a href=""><span class="glyphicon glyphicon-bookmark"></span> {{Vars::getVar('Low_Price_Guarantee')}}</a>

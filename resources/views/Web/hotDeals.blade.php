            ...
            <div class="col-md-8">
                ...
                <div class="row" >
                    <div class="col-md-12 exc-item-img-title">
                        <h3><span class="glyphicon glyphicon-briefcase"></span> {{Vars::getVar('Hot_Offers')}}</h3>
                    </div>

                </div>
                <div class="row">
                    <div class="col-md-12 exc-item-img">
                        <img src="{{asset('images/hot-deals.jpg')}}" alt="">
                    </div>
                </div>
                            ...
                            <div class="welcome-item">
                                ...
                                <div class="thumb-one row">
                                    ...
                                    <div class="col-md-6" style=" text-align: right;">
                                        <a href="{{route('tour.show',['city'=>urlencode($category->name),'tour'=>urlencode($item->name),'id'=>$item->id])}}" style="color:inherit; text-decoration: none;">
                                            {{ Vars::getVar('Add_to_basket') }} <i class="fa fa-cart-plus" style="color: #67ab34;" ></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="welcome-item-img-container">
                                    <a href="{{route('tour.show',['city'=>urlencode($category->name),'tour'=>urlencode($item->name),'id'=>$item->id])}}">
                                ...
                                <div class="welcome-item-txt-container">
                                    ...
                                    ...<a href="{{route('tour.show',['city'=>urlencode($category->name),'tour'=>urlencode($item->name),'id'=>$item->id])}}">Read More</a>

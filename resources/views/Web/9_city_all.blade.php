...
<h1 class="all-tour-title">{{$city->name}} <span>{{count($items)}} activities found</span></h1>
<div class="row">
    <div class="col-md-3">
        <form method="get" action="{{route('city.show.available',['id'=>$city->id])}}">
    ...
    <div class="col-md-9">
        ...
        <a href="{{route('tour.show',['city'=>$city->name,'tour'=>$item->name,'id'=>$item->id])}}" class="item-tour-link">

            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form method="post" action="{{route('Gallery.destroy',['topicId'=>$topicId])}}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('Topics.edit',['id'=>$topicId]) }}" class="btn btn-bitbucket"><i class="fa fa-dashboard"></i> Return Back to Item Dashboard</a>
                                    <button class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
                                    <a href="{{ route('Gallery.create',['id'=>$topicId])  }}" class="btn btn-primary">Upload New Images</a>
                                </div>
                            </div>
